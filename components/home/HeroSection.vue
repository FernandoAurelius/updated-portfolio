<template>
  <div class="relative bg-white dark:bg-gray-800 overflow-hidden">
    <div class="relative">
      <main>
        <div class="mx-auto py-8 max-w-7xl border-l border-r border-dashed border-gray-200 dark:border-gray-700">
          <div data-aos="zoom-in" class="lg:grid lg:grid-cols-12">
            <div class="px-4 sm:px-6 lg:border-r lg:border-dashed lg:border-gray-200 dark:border-gray-700 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
              <div>
                <nuxt-link v-if="$config.blog.enabled" :to="localePath('/blog')" 
                  class="group inline-flex items-center text-gray-700 dark:text-white bg-gray-100 dark:bg-gray-900 rounded-full p-0.5 pr-2 sm:text-base lg:text-sm xl:text-base hover:bg-gray-200 dark:hover:bg-black hover:text-gray-900 dark:hover:text-gray-200">
                ...
                <h1 class="mt-4 text-3xl tracking-tight font-extrabold text-gray-900 dark:text-white sm:mt-5 sm:leading-none lg:mt-6 lg:text-3xl xl:text-3xl">
                  <span class="md:block">{{ $t('hero.friendlyNeighborhood') }}</span>
                  <div>
                    <vue-typer :text="$t('hero.words')"></vue-typer>
                  </div>
                </h1>
                <p class="mt-3 text-base text-gray-600 dark:text-gray-300 sm:mt-5">
                  {{ $t('hero.description') }}
                </p>
                <p v-if="$config.workedAt.enabled" 
                  ...
                  Worked at | Onde trabalhei | Donde trabajé
                </p>
            ...
            <div class="mt-8 px-5 sm:mt-16 lg:mt-0 lg:col-span-6">
              <div class="flex-shrink-0 w-full sm:mx-auto flex flex-1 items-center justify-center rounded-lg sm:overflow-hidden">
                <img class="rounded-md h-80 shadow-lg dark:shadow-gray-900" 
                     :src="$config.image" 
                     :alt="$config.name">
              </div>
            </div>
