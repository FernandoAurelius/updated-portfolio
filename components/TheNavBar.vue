<template>
  <nav class="backdrop-filter backdrop-blur sticky top-0 z-40 w-full bg-white/70 dark:bg-gray-900/70">
    <div
      class="max-w-7xl border-l border-r border-dashed border-gray-200 dark:border-gray-700 mx-auto px-2 sm:px-4 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
          ...
          <div class="hidden lg:block lg:ml-6">
            <div class="flex space-x-4">
              <nuxt-link exact :to="localePath('/')"
                class="active text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white px-3 py-2 rounded-md text-sm font-bold transition-colors">
                {{ $t('nav.home') }}
              </nuxt-link>
        ...
        <div class="flex lg:hidden">
          <div class="mr-2 flex items-center md:hidden">
            <button @click="mobileMenuOpen = true" type="button"
              class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500 transition-colors"
        ...
        <div class="hidden md:flex flex-row space-x-2 items-center justify-center">
          ...
          <a v-if="$config.blog.enabled"
            class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
            href="/feed.xml" target="_blank">
