...
<template>
  <footer class="bg-gray-800 dark:bg-gray-900">
    <div class="max-w-7xl border-l border-r border-dashed border-gray-700 dark:border-gray-600 mx-auto px-4">
...
<template>
  <footer class="bg-gray-100 dark:bg-gray-800">
    <div class="max-w-7xl border-l border-r border-dashed border-gray-300 dark:border-gray-700 mx-auto px-4">
      <div class="pt-5 pb-12 md:flex md:items-center md:justify-between">
        <div class="flex space-x-6 md:order-2">
          <a 
        ...
        <p class="mt-4 text-sm text-gray-600 dark:text-gray-400 md:mt-0 md:order-1">
